  ...
  return (
    ...
    >
      ...
      <div className="relative h-[70%] w-full overflow-hidden group">
        ...
        />
        <div className="absolute top-3 sm:top-4 right-5 sm:right-6 z-30 bg-black/95 border border-[#00FF00] px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-lg text-[10px] sm:text-xs text-[#00FF00] font-black shadow-[0_0_20px_rgba(0,255,0,0.6)] flex items-center justify-center whitespace-nowrap">
          PRIZE: {event.prize}
        </div>
      </div>
